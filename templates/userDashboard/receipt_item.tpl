    ...
    <tbody>
        <tr>
            <td colspan="2">
                ...
                <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-4e3b96c90bb96cd7"></script>
                <!-- AddThis Button END -->
                {/literal}
            </td>
        </tr>
        <tr>
            ...
            <td>
                <dl class="dl-horizontal">
                    ...
                    <dd><a target="_blank" href="https://blockchain.info/tx/{$trans.transaction_hash}">Blockchain Confirmation Link</a></dd>
                </dl>
            </td>
        </tr>
        <tr>
